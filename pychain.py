...
# @TODO:
# Add an input area where you can get a value for `sender', 'reciever', 'amount' from the user.
sender, reciever, amount = [st.text_input(i) for i in ['Sender', 'Reciever', 'Amount']]
...
if st.button("Add Block"):
    ...
    # and `amount` values
    new_block = Block(
        record= Record(sender=sender, reciever=reciever, amount= float(amount)),
        creator_id=42,
